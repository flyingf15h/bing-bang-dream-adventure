...
##
## It shows the same six lanes node_2d.gd uses, lights the one each flick maps
...
##   Command line:  godot --path . res://ImuTest.tscn
##
...
## Mirrors node_2d.gd's default layout so this screen tests the same mapping.
...
func _note(text: String) -> void:
	...
	#   godot --headless --path . res://ImuTest.tscn
...
func _nearest_sector(angle_deg: float) -> int:
	# Deliberately a copy of node_2d.gd's version: this screen is here to
