...
const BG_ART: Texture2D = preload("res://assets/images/game_loss.png")
...
const MAPS := [
	{
		...
		"beatmap": "res://charts/badapple_hex.json",
		"audio": "res://assets/audio/Bad-Apple-Cut-Audio.ogg",
		"video": "res://assets/video/Bad-Apple-Cut-Video.ogv",
		"jacket": "res://assets/images/jacket_badapple.png",
	},
	{
		"title": "Flick Test",
		"caption": "100 BPM   32 notes   no music, no video",
		"beatmap": "res://charts/test_flicks.json",
		"audio": "",
		"video": "",
		"jacket": "res://assets/images/song_jacket.png",
	},
]
...
func _start(index: int) -> void:
	var map: Dictionary = MAPS[index]
	var game: Node = (load("res://scenes/Gameplay.tscn") as PackedScene).instantiate()
